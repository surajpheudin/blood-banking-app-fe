...
public class RequestDonorAdapter extends RecyclerView.Adapter<RecentDonationsViewHolder> {

    RequesterBean[] donors;
    Context context;

    public RequestDonorAdapter(RequesterBean[] donors, Context context) {
        this.donors = donors;
    ...
    public RecentDonationsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View donationsListView = layoutInflater.inflate(R.layout.received_requests_items, parent, false);
